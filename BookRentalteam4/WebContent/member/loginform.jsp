...
<div class="login">
         <div style="font-family: 'Black Han Sans', sans-serif; font-size:40px; color:#6f42c1;">로그인</div>
   <form method="post" action="<%=request.getContextPath()%>/Login.do">
        ...
        <input type="password" name="passwd" id="passwd" placeholder="Password" required="required" />
        <button type="button" value="회원가입" onClick="location.href='<%=request.getContextPath()%>/joinform.do' "class="btn btn-primary btn-block btn-large">회원가입</button>
        <button type="submit" value="로그인" class="btn btn-primary btn-block btn-large">로그인</button>
    </form>
</div>
